...
$router->post('/api/settings/base-info/account/excel-upload', 'AccountController@apiSaveFromExcel', [
    'key' => 'api.settings.base_info.account.excel_upload',
    'name' => '계정과목 엑셀 업로드',
    'category' => '기초정보',
    'auth' => true,
    'permissions' => ['save'],
...
$router->get('/api/settings/base-info/account/template', 'ChartAccountController@apiTemplate', [
    'key' => 'api.settings.base_info.account.template',
    'name' => '계정과목 양식 다운로드',
    'category' => '기초정보',
    'auth' => true,
    'permissions' => ['view'],
...
$router->get('/api/settings/base-info/account/excel', 'ChartAccountController@apidownloadAllExcel', [
    'key' => 'api.settings.base_info.account.excel',
    'name' => '계정과목 엑셀 다운로드',
    'category' => '기초정보',
    'auth' => true,
    'permissions' => ['view'],
...
$router->get('/api/ledger/accounts/excel', 'ChartAccountController@apidownloadAllExcel', [
    'key' => 'api.ledger.accounts.excel',
    'name' => 'api/ledger/accounts/excel',
    'category' => '회계관리',
    'auth' => true,
    'permissions' => ['view'],
    'log' => true,
...
$router->get('/api/ledger/voucher/download', 'VoucherController@apiDownload', [
    'key' => 'api.ledger.voucher.download',
    'name' => '일반전표 엑셀 다운로드',
    'category' => '회계관리',
    'auth' => true,
    'permissions' => ['view'],
