...
$router->get('/api/import/evidences', 'EvidenceListController@apiList', [
    ...
    'permission_name' => '조회',
    'permission_description' => '생성센터 조회',
    'name' => '생성센터 조회',
    'description' => '회계관리 > 자료관리 > 생성센터 > 조회',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['view'],
    'log' => false,
...
$router->get('/api/import/evidences/download', 'EvidenceDownloadController@apiDownload', [
    ...
    'name' => '증빙 다운로드',
    'description' => '회계관리 > 자료관리 > 생성센터 > 다운로드',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['view'],
    'log' => false,
...
$router->get('/api/import/evidences/trash', 'EvidenceLifecycleController@apiTrashList', [
    ...
    'name' => '증빙 휴지통조회',
    'description' => '회계관리 > 자료관리 > 생성센터 > 휴지통조회',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['view'],
    'log' => false,
...
$router->post('/api/import/evidence/split-child', 'EvidenceSplitController@apiSplitChild', [
    ...
    'page' => '생성센터',
    'page_description' => '생성센터 관리',
    'permission_name' => '하위분할생성',
    'permission_description' => '증빙 하위 분할 생성',
    'name' => '증빙 하위분할생성',
    'description' => '회계관리 > 자료관리 > 생성센터 > 하위분할생성',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['save'],
    'log' => true,
...
$router->post('/api/import/evidence/processing-child/delete', 'EvidenceProcessingController@apiDeleteProcessingChild', [
    ...
    'page' => '생성센터',
    'page_description' => '생성센터 관리',
    'permission_name' => '하위항목삭제',
    'permission_description' => '증빙 하위항목 삭제',
    'name' => '증빙 하위항목삭제',
    'description' => '회계관리 > 자료관리 > 생성센터 > 하위항목삭제',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['delete'],
    'log' => true,
...
$router->post('/api/import/evidence/processing-child/update', 'EvidenceProcessingController@apiUpdateProcessingChild', [
    ...
    'page' => '생성센터',
    'page_description' => '생성센터 관리',
    'permission_name' => '하위항목수정',
    'permission_description' => '증빙 하위항목 수정',
    'name' => '증빙 하위항목수정',
    'description' => '회계관리 > 자료관리 > 생성센터 > 하위항목수정',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['save'],
    'log' => true,
...
$router->get('/api/import/evidence/summary-search', 'EvidenceDownloadController@apiSearchSummary', [
    ...
    'name' => '증빙 요약검색',
    'description' => '회계관리 > 자료관리 > 생성센터 > 요약검색',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['view'],
    'log' => true,
...
$router->post('/api/import/evidences/bulk-save', 'EvidenceSaveController@apiBulkSave', [
    ...
    'name' => '증빙 일괄저장',
    'description' => '회계관리 > 자료관리 > 생성센터 > 일괄저장',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['save'],
    'log' => true,
...
$router->post('/api/import/evidences/status', 'EvidenceStatusController@apiUpdateStatus', [
    ...
    'name' => '증빙 상태변경',
    'description' => '회계관리 > 자료관리 > 생성센터 > 상태변경',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['save'],
    'log' => true,
...
$router->post('/api/import/evidences/reorder', 'EvidenceStatusController@apiReorder', [
    ...
    'name' => '증빙 정렬저장',
    'description' => '회계관리 > 자료관리 > 생성센터 > 정렬저장',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['save'],
    'log' => true,
...
$router->post('/api/import/evidences/restore-bulk', 'EvidenceLifecycleController@apiRestore', [
    ...
    'name' => '증빙 일괄복구',
    'description' => '회계관리 > 자료관리 > 생성센터 > 일괄복구',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['save'],
    'log' => true,
...
$router->post('/api/import/evidences/restore-all', 'EvidenceLifecycleController@apiRestoreAll', [
    ...
    'name' => '증빙 전체복구',
    'description' => '회계관리 > 자료관리 > 생성센터 > 전체복구',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['save'],
    'log' => true,
...
$router->post('/api/import/evidences/purge', 'EvidenceLifecycleController@apiPurge', [
    ...
    'name' => '증빙 영구삭제',
    'description' => '회계관리 > 자료관리 > 생성센터 > 영구삭제',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['delete'],
    'log' => true,
...
$router->post('/api/import/evidences/purge-bulk', 'EvidenceLifecycleController@apiPurge', [
    ...
    'name' => '증빙 일괄영구삭제',
    'description' => '회계관리 > 자료관리 > 생성센터 > 일괄영구삭제',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['delete'],
    'log' => true,
...
$router->post('/api/import/evidences/purge-all', 'EvidenceLifecycleController@apiPurgeAll', [
    ...
    'name' => '증빙 전체영구삭제',
    'description' => '회계관리 > 자료관리 > 생성센터 > 전체영구삭제',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['delete'],
    'log' => true,
...
$router->post('/api/import/create-transactions', 'EvidenceTransactionController@apiCreateTransactions', [
    'key' => 'api.import.create_transactions',
    'page' => '생성센터',
    'page_description' => '생성센터 관리',
    'permission_name' => '거래생성',
    'permission_description' => '거래 생성',
    'name' => '거래 생성',
    'description' => '회계관리 > 자료관리 > 생성센터 > 거래생성',
    'category' => '회계관리 > 자료관리',
    'auth' => true,
    'permissions' => ['save'],
    'log' => true,
