<?php
// 경로: PROJECT_ROOT . '/app/models/Dashboard/SystemClientModel.php'
namespace App\Models\System;

use PDO;

class SystemClientModel
{
    // 2. PDO 보관
    private PDO $db;
    ...
    {
        $sql = "SELECT * FROM system_clients WHERE is_active = 1";
        $params = [];

        $allowed = [
            'code','client_name','company_name','ceo_name','business_number',
            'business_status','phone','email','registration_date','note','memo',
            'address','address_detail','client_type','tax_type','client_category',
        ...
        $likeFields = [
            'client_name','company_name','ceo_name','business_status',
            'email','note','address','address_detail'
        ];
    ...
    public function create(array $data): bool
    {
        ...
        return $stmt->execute([
            ...
            'manufacture_number' => $data['manufacture_number'] ?? null,
            'account_holder' => $data['account_holder'] ?? null,
            'bank_copy' => $data['bank_copy'] ?? null,
