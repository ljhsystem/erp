<?php
// 경로: PROJECT_ROOT . '/app/models/user/UserProfileModel.php'
    ...
    * ============================================================ */
    public function getList(array $filters = []): array
    {
        $sql = "
            ...
            LEFT JOIN user_profiles p_created_user
                ON p_created_user.user_id = p.created_by
            LEFT JOIN user_profiles p_updated_user
                ON p_updated_user.user_id = p.updated_by
            LEFT JOIN user_profiles u_created_user
                ON u_created_user.user_id = u.created_by
            LEFT JOIN user_profiles u_updated_user
                ON u_updated_user.user_id = u.updated_by
            LEFT JOIN user_profiles pw_updated_user
                ON pw_updated_user.user_id = u.password_updated_by
            LEFT JOIN user_profiles deleted_user
