<?php
// 경로: PROJECT_ROOT . '/app/views/main/index.php'
// 페이지 캐싱 방지
if (!headers_sent()) {
...
$pageStyles = AssetHelper::css('/assets/css/pages/main/index.css');
$pageScripts  = AssetHelper::js('https://cdn.jsdelivr.net/npm/chart.js');
$pageScripts .= AssetHelper::js('/assets/js/pages/main/index.js');
    ...
    <div class="card mt-2">
        <div class="card-body py-2">
            ...
            <div class="d-flex flex-wrap gap-2 quick-links">
                ...
                <a href="/main/report" class="btn btn-outline-secondary btn-sm">📈 통합 보고서</a>
                <a href="/main/calendar" class="btn btn-outline-info btn-sm">📅 일정관리</a>
            </div>
        </div>
    </div>
</main>
