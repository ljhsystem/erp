<!-- 경로: PROJECT_ROOT . '/app/views/main/settings/base-info/partials/project_modal.php' -->
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body py-2">
                            <div class="row g-2">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label">프로젝트명(내부용) *</label>
                                    <input type="text"
                                           name="project_name"
                                ...
                                <div class="col-md-4">
                                    <label class="form-label">공사명(계약명)</label>
                                    <input type="text"
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body py-2">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label">발주자분류</label>
                                    <input type="text"
                                           name="client_type"
                                           id="modal_client_type"
                                           class="form-control form-control-sm"
                                           placeholder="예: 경기도(지방자치단체)">
                                </div>
                                ...
                                <div class="col-md-3">
                                    <label class="form-label">현장대리인계</label>
                                    <select name="site_agent"
                                            id="modal_site_agent"
                                            class="form-select form-select-sm">
                                        <option value=""></option>
                                    </select>
                            ...
                            <div class="row g-2 mt-2">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label">감독관 / 소장</label>
                                    <input type="text"
                                           name="director"
                                           id="modal_director"
                                           class="form-control form-control-sm">
