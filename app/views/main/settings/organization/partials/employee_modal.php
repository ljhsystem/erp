<?php
// 경로: PROJECT_ROOT . '/app/views/main/settings/organization/partials/employee_modal.php'
?>
            ...
            <div class="tab-pane fade" id="edit_tab_files">
              <div class="row g-3">
                ...
                <div class="col-md-4 text-center">
                  ...
                  <select name="representative_qualification_id" id="edit_representative_qualification_id" class="form-select form-select-sm"><option value="">대표자격 없음</option></select>
                  <div class="form-text text-start">해당 직원의 검증 완료된 유효 자격만 선택할 수 있습니다. 만료예정 자격은 상태와 함께 표시됩니다.</div>
