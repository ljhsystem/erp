<?php
// 경로: PROJECT_ROOT . '/app/views/main/calendar.php'
...
$pageStyles = AssetHelper::css('/assets/css/pages/main/calendar/calendar.css');
$pageScripts =
    ...
    "\n<!-- 1️⃣ 서버 / 상태 (전역) -->\n" .
    AssetHelper::js('/assets/js/pages/main/calendar/api.js') .
    AssetHelper::js('/assets/js/pages/main/calendar/store.js') .

    "\n<!-- 2️⃣ 상단 바 -->\n" .
    AssetHelper::js('/assets/js/pages/main/calendar/topbar.js') .

    "\n<!-- 3️⃣ 좌측 사이드바 -->\n" .
    AssetHelper::js('/assets/js/pages/main/calendar/sidebar.left.create.js') .
    AssetHelper::module('/assets/js/pages/main/calendar/sidebar.left.mini.js') .
    AssetHelper::js('/assets/js/pages/main/calendar/sidebar.left.list.js') .

    "\n<!-- 4️⃣ 메인 캘린더 -->\n" .
    AssetHelper::js('/assets/js/pages/main/calendar/view.js') .

    "\n<!-- 5️⃣ 우측 사이드바 (🔥 AdminPicker 사용 → module) -->\n" .
    AssetHelper::module('/assets/js/pages/main/calendar/sidebar.right.edit.js') .
    AssetHelper::module('/assets/js/pages/main/calendar/sidebar.right.filter.js') .
    AssetHelper::module('/assets/js/pages/main/calendar/sidebar.right.create.js') .
    AssetHelper::module('/assets/js/pages/main/calendar/sidebar.right.list.js') .

    "\n<!-- 6️⃣ 모달 (AdminPicker 사용 → module) -->\n" .
    AssetHelper::module('/assets/js/pages/main/calendar/modal.event.view.js') .
    AssetHelper::module('/assets/js/pages/main/calendar/modal.event.edit.js') .
    AssetHelper::module('/assets/js/pages/main/calendar/modal.event.edit.repeat.js') .
    AssetHelper::module('/assets/js/pages/main/calendar/modal.task.view.js') .
    AssetHelper::module('/assets/js/pages/main/calendar/modal.task.edit.js') .
    AssetHelper::module('/assets/js/pages/main/calendar/modal.quick.js') .
    AssetHelper::module('/assets/js/pages/main/calendar/modal.trash.js') .

    "\n<!-- 7️⃣ 🔗 최종 연결자 (항상 맨 마지막) -->\n" .
    AssetHelper::js('/assets/js/pages/main/calendar/bootstrap.js');
