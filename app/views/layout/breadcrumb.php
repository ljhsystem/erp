...
$pageMap = [
    ...
    '/ledger/funds/cash-ledger' => ['items' => ['회계관리', '자금관리', '현금출납장']],
    '/ledger/funds/daily-report' => ['items' => ['회계관리', '자금관리', '자금일보']],
    '/ledger/funds/account-balances' => ['items' => ['회계관리', '자금관리', '계좌잔액현황']],
    '/ledger/funds/unlinked-transactions' => ['items' => ['회계관리', '자금관리', '미연결입출금']],
