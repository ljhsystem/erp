<?php
// 경로: PROJECT_ROOT . '/app/views/dashboard/settings/system/site.php'
?>
      ...
      <div class="col-md-6">
        ...
        <div class="card h-100">
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              <label class="form-label fw-semibold">사이트 제목 (로고 옆)</label>
              <input type="text" class="form-control" name="site_title">
            </div>

            <div class="mb-3">
              <label class="form-label fw-semibold">홈 인트로 제목</label>
              <input type="text" class="form-control" name="home_intro_title">
            </div>

            <div class="mb-3">
              <label class="form-label fw-semibold">홈 인트로 문구</label>
              <textarea class="form-control" name="home_intro_description" rows="5"></textarea>
            </div>

            <div class="mb-3">
              <label class="form-label fw-semibold">홈 인트로 이동 URL</label>
              <input type="text" class="form-control" name="home_intro_url">
            </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="site_font_family">
                ...
                <!-- 행 포커스 스타일 -->
                <div class="col-md-6">
                    <label class="form-label fw-semibold">행 포커스 스타일</label>
                ...
                <!-- 아이콘 표시 크기 -->
                <div class="col-md-6">
                    <label class="form-label fw-semibold">아이콘 표시 크기</label>
                ...
                <!-- 애니메이션 효과 -->
                <div class="col-md-6">
                    <label class="form-label fw-semibold">애니메이션 효과</label>
