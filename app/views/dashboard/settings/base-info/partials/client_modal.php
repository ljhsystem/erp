              ...
              <div class="card-body py-2">
                ...
                <div class="row g-2 mt-2">
                  <div class="col-md-4">
                    ...
                    <input type="text" name="business_type" id="modal_business_type" class="form-control form-control-sm">
                  </div>
                  <div class="col-md-4">
                    <label class="form-label">업종</label>
                    <input type="text" name="business_category" id="modal_business_category" class="form-control form-control-sm">
                  </div>
                  <div class="col-md-4">
                    <label class="form-label">사업자등록 상태</label>
                    <select name="business_status" id="modal_business_status" class="form-select form-select-sm">
                      <option value="">선택</option>
            ...
            <div class="card mb-3">
              ...
              <div class="card-body py-2">
                <div class="row g-2">
                  ...
                  <div class="col-md-3">
                    <label class="form-label">대표자연락처</label>
                ...
                <div class="row g-2 mt-2">
                  ...
                  <div class="col-md-5">
                    ...
                    <div class="input-group mb-1">
                      <input type="text" name="address" id="modal_address" class="form-control form-control-sm" placeholder="기본주소">
                      <button type="button" class="btn btn-outline-primary btn-sm" data-addr-picker data-target="#modal_address">주소검색</button>
                    </div>
                    <input type="text" name="address_detail" id="modal_address_detail" class="form-control form-control-sm" placeholder="상세주소 (예: 동/호, 건물명)">
                  </div>
                </div>
              </div>
            </div>
