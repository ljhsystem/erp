<?php
// Path: PROJECT_ROOT . '/app/views/dashboard/settings/base-info/work-team.php'
?>

<div class="work-team-page" id="work-team-main">
    <div class="page-header">
        <h5 class="mb-1 fw-bold">팀관리</h5>
...
<?php include __DIR__ . '/partials/work-team_modal.php'; ?>
