...
class QueryService
{
    ...
    * ========================================================= */
    ...
    public function getEventCalendarId(string $id): ?string
    {
        $stmt = $this->pdo->prepare("
            SELECT calendar_id
    ...
    public function getTaskCalendarId(string $id): ?string
    {
        $stmt = $this->pdo->prepare("
            SELECT calendar_id
    ...
    public function getTaskCollectionHref(string $id): ?string
    {
        $stmt = $this->pdo->prepare("
