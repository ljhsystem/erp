...
final class CodeReferenceRegistry
{
    ...
    private const GROUPS = [
        ...
        'EMPLOYMENT_CONTRACT_TYPE', 'EMPLOYMENT_RULE_OPERATOR', 'EMPLOYMENT_RULE_POLICY',
        'EMPLOYMENT_RULE_SCOPE_TYPE', 'EMPLOYMENT_RULE_STATUS', 'EMPLOYMENT_RULE_TYPE',
        'EMPLOYMENT_RULE_UNIT', 'EMPLOYMENT_RULE_VALUE_TYPE', 'EMPLOYMENT_STATUS',
        ...
        'PAYMENT_TIMING', 'PERSONAL_EXPENSE_CATEGORY', 'PERSONAL_EXPENSE_PAYMENT_METHOD',
        ...
        'STATUTORY_STANDARD_TYPE', 'TAX_TYPE', 'TRANSACTION_DIRECTION', 'UNIT',
    ...
    private const COLUMN_REFERENCES = [
        ...
        'EMPLOYMENT_CATEGORY' => [
            ...
            ['institution_employment_rules_scopes', 'employment_category_code', '취업규칙 적용범위'],
        ],
        ...
        'EMPLOYMENT_RULE_OPERATOR' => [['institution_employment_rules_items', 'operator_code', '취업규칙 연산자']],
        'EMPLOYMENT_RULE_POLICY' => [['institution_employment_rules_items', 'policy_code', '취업규칙 정책']],
        'EMPLOYMENT_RULE_SCOPE_TYPE' => [['institution_employment_rules_scopes', 'scope_type_code', '취업규칙 적용범위']],
        'EMPLOYMENT_RULE_STATUS' => [['institution_employment_rules_revisions', 'status_code', '취업규칙 개정상태']],
        'EMPLOYMENT_RULE_TYPE' => [['institution_employment_rules', 'rule_type_code', '취업규칙 종류']],
        'EMPLOYMENT_RULE_UNIT' => [['institution_employment_rules_items', 'unit_code', '취업규칙 단위']],
        'EMPLOYMENT_RULE_VALUE_TYPE' => [['institution_employment_rules_items', 'value_type_code', '취업규칙 값 형식']],
        'EMPLOYMENT_STATUS' => [
