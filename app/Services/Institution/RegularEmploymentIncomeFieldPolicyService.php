...
class RegularEmploymentIncomeFieldPolicyService
{
    private const PAGE_KEY = 'institution.income-data.regular-employment';
    private const EDITABLE_FIELDS = ['income_year_month', 'title', 'description'];
