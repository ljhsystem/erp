...
ADD COLUMN `transaction_line_type` VARCHAR(50) NULL AFTER `processing_item_id`;

INSERT INTO `system_codes`
    (`id`, `sort_no`, `code_group`, `group_name`, `code`, `code_name`, `note`, `is_active`, `created_by`, `updated_by`)
