...
class EvidenceGenerationController
{
    ...
    private ?EvidenceGenerationSaveService $evidenceGenerationSaveService = null;
    ...
    {
        (new EvidencePayloadController($this->pdo))->apiDownload();
    }

    public function apiUpdateStatus(): void
    {
        (new EvidenceStatusController($this->pdo))->apiUpdateStatus();
    }

    public function apiReorder(): void
    {
        (new EvidenceStatusController($this->pdo))->apiReorder();
    }
    ...
    private function evidenceGenerationService(): EvidenceGenerationService
    {
        if ($this->evidenceGenerationService === null) {
            $this->evidenceGenerationService = new EvidenceGenerationService(
                ...
                function (): void {
                    $this->evidenceBankHelperService()->ensureBankTransactionBalanceColumns();
                },
                function (): void {
                    $this->evidenceBankHelperService()->ensureBankTransactionEvidenceRows();
                },
                ...
                fn(string $formatId): array => $this->evidenceFormatMappingService()->columns($formatId),
    ...
    private function evidenceGenerationSaveService(): EvidenceGenerationSaveService
    {
        if ($this->evidenceGenerationSaveService === null) {
            $this->evidenceGenerationSaveService = new EvidenceGenerationSaveService($this->pdo, [
                ...
                'formatWithColumns' => fn(string $id): ?array => $this->evidenceFormatMappingService()->formatWithColumns($id),
        ...
        return $this->evidenceGenerationSaveService;
    }
