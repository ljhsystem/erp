...
class StatutoryStandardController
{
    ...
    public function index(): void
    {
        ...
        ob_start();
        require PROJECT_ROOT . '/app/views/main/settings.php';
    ...
    public function apiCorrectRevision(): void
    {
        $this->respond(fn(): array => $this->service->createRevisionCorrection($this->input(), $this->sourceFiles()));
    }
    public function apiRevisionChain(): void
    {
        $this->respond(fn(): array => $this->service->revisionChain((string)($_GET['id'] ?? '')));
    }
