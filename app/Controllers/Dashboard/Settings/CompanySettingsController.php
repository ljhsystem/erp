<?php
// 경로: PROJECT_ROOT . '/app/controllers/dashboard/settings/CompanySettingsController.php'
...
class CompanySettingsController
{
    ...
    controller: CompanySettingsController@apiDetail
    설명:
    ...
    controller: CompanySettingsController@apiSave
    설명:
