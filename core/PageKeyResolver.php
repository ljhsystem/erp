...
class PageKeyResolver
{
    ...
    private array $legacyPrefixMap = [
        'api.main.calendar.' => 'main.calendar',
        ...
        'api.institution.human_resources.job_assignment.' => 'web.institution.human_resources.job_assignments',
        'api.institution.human_resources.pay_component.' => 'web.institution.human_resources.employment_contracts',
        'api.institution.human_resources.personnel_action.' => 'web.institution.human_resources.personnel_actions',
        'api.institution.human_resources.qualification_education.' => 'web.institution.human_resources.qualification_education',
        ...
        'api.auth.account_lock.' => 'auth.account_lock',
    ];

    /** @var array<string,string> */
    private array $legacyExactMap = [
        'web.main.dashboard' => 'main.dashboard',
        'web.main.report' => 'main.report',
        'web.main.activity' => 'main.activity',
        'web.main.notifications' => 'main.notifications',
        'web.main.kpi' => 'main.kpi',
        'web.main.calendar' => 'main.calendar',
        'web.main.settings' => 'main.settings',
        'api.main.profile_summary' => 'main.dashboard',
        'api.settings.system.data_table_columns' => 'main.settings',
        'api.user.profile.detail' => 'profile.view',
        'api.user.profile.save' => 'profile.view',
