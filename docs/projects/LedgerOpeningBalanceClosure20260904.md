...
2026-09-05 보완 계약: 석향의 최초 회계기간은 `2013-07-01 ~ 2013-12-31`이며 승계잔액이 없어 0원 개시로 확정한다. 이후 회계연도는 매년 `01-01 ~ 12-31`을 사용하고 전기말 확정잔액을 기초잔액으로 이월한다.

- 운영 최초 개시 문서: `13680aa6-6a7f-45f6-b7c7-e4083e56c835`
- 기초전표: 없음(0원 개시)
- 기록 Actor: `SYSTEM:OPENING_BALANCE_INITIALIZATION`
- 적용 Migration: `20260905_01_allow_zero_opening_balance_without_voucher`
