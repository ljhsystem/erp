...
const ACCOUNT_COLUMN_MAP = {
    account_code : { label:"코드", visible:true },
    ...
    document.addEventListener('DOMContentLoaded', async () => {     
        ...
        excelModal = new bootstrap.Modal(
            document.getElementById('accountExcelModal')
        );
            ...
            buttons: [
    ...
    
                {
                    ...
                    action: () => {
                        ...
                        document.getElementById('accountModalLabel').textContent = '계정 신규 등록';
