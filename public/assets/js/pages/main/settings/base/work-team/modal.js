...
export function createWorkTeamModalModule({
    ...
    function initModal() {
        ...
        if (modalEl && !workTeamModalInitialized) {
            workTeamModalInitialized = true;
    ...
    function bindModalEvents() {
        ...
        window.jQuery('#btnDeleteWorkTeam').on('click', async function () {
            ...
            try {
                await runDeleteProgress({ total: 1, title: '소프트삭제 처리 중', step: '팀을 휴지통으로 이동 중', trashChanged: true }, async () => {
